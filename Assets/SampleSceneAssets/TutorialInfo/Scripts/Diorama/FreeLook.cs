...
public class FreeLook : MonoBehaviour
{
    ...
    [SerializeField]
    string CameraUpActionName = "Up";

    [SerializeField]
    string CameraDownActionName = "Down";

    [SerializeField]
    string CameraMoveActionName = "Move";

    [SerializeField]
    string CameraMouseLookActionName = "MousePosition";

    [SerializeField]
    string CameraGamepadLookActionName = "GamepadLook";
